...
import {
  columnslistarEquipoStock,
  statusOptions,
  getlistarEquipoStock,
...
export default function TablaEquipoStockComponent() {
  ...
  const headerColumns = React.useMemo(() => {
    if (visibleColumns === "all") return columnslistarEquipoStock;

    return columnslistarEquipoStock.filter((column) =>
        ...
        <div className="flex justify-between gap-3 items-end">
          ...
          <div className="flex gap-3">
            ...
            <Dropdown>
              ...
              >
                {columnslistarEquipoStock.map((column) => (
