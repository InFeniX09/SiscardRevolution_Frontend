...
export default function TablaTipoEquipoComponent() {
  ...
  const headerColumns = React.useMemo(() => {
    if (visibleColumns === "all") return columnslistarTipoEquipo;

    return columnslistarTipoEquipo.filter((column) =>
  ...
  const filteredItems = React.useMemo(() => {
    ...
    if (
      ...
      filteredUsers = filteredUsers.filter((user) =>
        Array.from(statusFilter).includes(user.Clasificacion)
      );
    }
  ...
  const renderCell = React.useCallback((user: User, columnKey: React.Key) => {
    ...
    switch (columnKey) {
      case "name":
        return (
          <User
            avatarProps={{ radius: "lg", src: user.Clasificacion }}
        ...
        <div className="flex justify-between gap-3 items-end">
          ...
          <div className="flex gap-3">
            ...
            <Dropdown>
              ...
              >
                {columnslistarTipoEquipo.map((column) => (
