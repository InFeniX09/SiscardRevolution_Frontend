...
import {
  columnslistarEquipoControl,
  statusOptions,
  getlistarEquipoControl,
...
export default function TablaEquipoControlComponent() {
  ...
  const headerColumns = React.useMemo(() => {
    if (visibleColumns === "all") return columnslistarEquipoControl;

    return columnslistarEquipoControl.filter((column) =>
        ...
        <div className="flex justify-between gap-3 items-end">
          ...
          <div className="flex gap-3">
            ...
            <Dropdown>
              ...
              >
                {columnslistarEquipoControl.map((column) => (
