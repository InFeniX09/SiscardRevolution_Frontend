...
import { ButtonAddComponent } from "@/src/components/ui/Button/ButtonAdd";
...
export function TablaMarcaComponent<T>(props: { marca: T[] }) {
  ...
  const headerColumns = React.useMemo(() => {
    if (visibleColumns === "all") return columnslistarMarca;

    return columnslistarMarca.filter((column) =>
  ...
  const renderCell = React.useCallback((user: datos, columnKey: React.Key) => {
    const cellValue = user[columnKey as keyof datos];
