...
export default function TablaEquipoDescuentoComponent() {
  ...
  const headerColumns = React.useMemo(() => {
    if (visibleColumns === "all") return columnslistarEquipoDescuento;

    return columnslistarEquipoDescuento.filter((column) =>
        ...
        <div className="flex justify-between gap-3 items-end">
          ...
          <div className="flex gap-3">
            ...
            <Dropdown>
              ...
              >
                {columnslistarEquipoDescuento.map((column) => (
