...
interface Props {
  array: EquipoDescuento[];
}

export default function TableEquipoDescuentoComponent({ array }: Props) {
  ...
  const sortedItems = React.useMemo(() => {
    return [...items].sort((a: EquipoDescuento, b: EquipoDescuento) => {
      const first = a[sortDescriptor.column as keyof EquipoDescuento] as number;
      const second = b[
        sortDescriptor.column as keyof EquipoDescuento
      ] as number;
  ...
  const renderCell = React.useCallback(
    (user: EquipoDescuento, columnKey: React.Key) => {
