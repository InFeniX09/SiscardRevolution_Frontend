...
export default function TablaModeloComponent() {
  ...
  const headerColumns = React.useMemo(() => {
    if (visibleColumns === "all") return columnslistarModelo;

    return columnslistarModelo.filter((column) =>
        ...
        <div className="flex justify-between gap-3 items-end">
          ...
          <div className="flex gap-3">
            ...
            <Dropdown>
              ...
              >
                {columnslistarModelo.map((column) => (
